...
<div class="container m-auto pt-5">
  <h1 class="font-semibold lg:mb-6 mb-3 text-2xl">Create New Post</h1>
      <form method="post" action="/posting" enctype="multipart/form-data">
       @csrf
   <div class="mb-3">
     <label for="image" class="form-label @error('image') is-invalid @enderror">Upload File</label>
   ...
   <div class="mb-3">
     <label for="video" class="form-label @error('video') is-invalid @enderror">Upload File</label>
